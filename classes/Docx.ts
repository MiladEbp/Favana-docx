...
export default class  Docx{
    ...
    private  stringPdata:any = " ";
    private  stringTbldata:any = " ";
...
////////////////////////////////// Check for Type Send File /////////////////

    }// Method generate


    CreateStream(next:any){
      next(createReadStream(this.infoFile));
    }
}// class docx
